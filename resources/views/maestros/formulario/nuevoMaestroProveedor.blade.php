    ...
    @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" maxlength="50" class="txt-form" name="telefono_contacto" id="tContacto">
                </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" maxlength="50" class="txt-form" required name="telefono_fijo" id="tFijo">
            </div>
            <div class="col-md-6">
                <label>Página web</label>
            ...
            <div class="col-md-6">
                ...
                <input type="text" maxlength="50" class="txt-form" name="telefono_celular" id="tMovil">
            </div>
