<form action="{{route('maestroProveedor.store')}}" name="frm1" id="fm" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <input type="text" maxlength="50" value="{{old('nombre_proveedor')}}"  class="txt-form" name="nombre_proveedor" id="nombre_proveedor" >
        ...
        <div class="col-md-6">
            ...
            <input type="text" maxlength="50"  class="txt-form" value="{{old('numero_proveedor_icg')}}" name="numero_proveedor_icg" id="numero_proveedor_icg" required>
