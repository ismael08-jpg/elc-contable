<form action="{{route('maestroProveedor.store')}}" name="frm1" id="fm" method="POST">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <input type="text" maxlength="100" value="{{old('nombre_proveedor')}}" required  class="txt-form" name="nombre_proveedor" id="nombre_proveedor" >
        ...
        <div class="col-md-6">
            ...
            <input type="text" maxlength="50"  class="txt-form" value="{{old('numero_proveedor_icg')}}" name="numero_proveedor_icg" id="numero_proveedor_icg" >
            @error('numero_proveedor_icg')
            <small>*{{$message}}</small>
            @enderror
        </div>
        <div class="col-md-6">
            <label>Otro número de proveedor</label>
            <input type="text" maxlength="50" value="{{old('numero_proveedor')}}" class="txt-form" name="numero_proveedor" id="numero_proveedor" >
            @error('numero_proveedor')
            <small>*{{$message}}</small>
            @enderror
        </div>
        <div class="col-md-10">
            <label>Nombre Comercial<b>*</b></label>
            <input type="text" maxlength="100"  value="{{old('nombre_comercial')}}"   class="txt-form" required name="nombre_comercial" id="nombre_comercial">
...
<div class="row">
    ...
    <div class="col-6">
        ...
        <div class="mt-2 col-md-3">
            ...
            <input type="number"  class="txt-form" value="{{old('porc_retencion', 0)}}" required min="0" id="porc_retencion" name="porc_retencion">
        ...
        <div class="mt-2 col-md-6">
            ...
            <input type="number" value="{{old('comision', 0)}}" required    class="txt-form" min="0" name="comision" id="comision">
            @error('comision')
                <small>*{{$message}}</small>
            @enderror
        </div>
