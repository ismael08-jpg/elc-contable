                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div id="paraiso_fiscal">
                                            <input type="radio" id="natural" readonly name="paraiso_fiscal" required value="Si"  onclick="des(this.form,0)">
                                            <label for="male">Si</label><br>
                                            <input type="radio" readonly id="juridico" name="paraiso_fiscal" value="No"  onclick="des(this.form,1)">
                        ...
                        <div class="col-6">
                            ...
                            <div class="col-md-3">
                                ...
                                <div id="hiddenNRegistroValidado">
                                    <input type="text"  name="n_registro_fiscal" class="txt-form" disabled    required id="nRegistroValidado" >
                                </div>
                            </div>
