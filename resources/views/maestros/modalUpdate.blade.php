                      ...
                      <div class="col-md-12">
                        <center>
                          ...
                          <div class="col-md-6">
                              ...
                              <input type="text" class="form-control" id="fnombre_cliente" name="fnombre_cliente" required>
                          </div>
                          <div class="col-md-6">
                              <label>N° Cliente ICG<b>*</b></label>
                              <input type="text" class="form-control" name="fnumero_cliente_icg" id="fnumero_cliente_icg" required>
                          </div>
                          <div class="col-md-6">
                              <label>Otro número de cliente</label>
                              <input type="text" class="form-control" name="fnumero_cliente" id="fnumero_cliente">
                          </div>
                          <div class="col-md-6">
