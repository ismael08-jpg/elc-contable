<table style="border-radius: 10px;" id="maestroProveedorTable"  class="w-100 align-items-center table table-responsive table-sm table-hover">
    <thead class="thead-dark">
        <tr>
             ...
             <th>ID Proveedor</th>
             <th>Nombre</th>
             <th>Número de proveedor ICG</th>
             <th>Otro número de proveedor</th>
    ...
    <tbody>
        @foreach ($maestro as $us)
         <tr>
             ...
             <td>{{$us->id_proveedor}}</td>
             <td>{{$us->nombre_proveedor}}</td>
             <td>{{$us->numero_proveedor_icg}}</td>
             <td>{{$us->numero_proveedor}}</td>
             ...
             <td>
                <input type="image" onclick="eliminarM({{$us->id_maestro_proveedor}},{{$us->id_proveedor}});" form="formulario1" class="btn-calc math sombra" height="40px" width="40px" 
