    ...
    public function store(Request $request){
        ...
        $validacion = $request->validate([
           ...
           'paraiso_fiscal' =>'required',
            ...
            'cobra_iva' =>'required',
            'entera_iva' =>'required',
            'porc_retencion' => 'required|numeric|min:0.01',
            'percepcion' =>'required',
            'cta_pasivo_uno' =>'required',
            //'cta_pasivo_dos' =>'required',
            'cta_activo_uno' =>'required',
             //'cta_activo_dos' =>
            'comision' => 'required|numeric|min:0.01',
            'emitira_nc' =>'required',
